...
const members = [
  { name: "Alex Rivet", role: "Director", img: "https://i.pravatar.cc/500?u=a" },
  { name: "Elena Haas", role: "Lead Strategist", img: "https://i.pravatar.cc/500?u=b" },
  { name: "Marcus Zen", role: "Tech Architect", img: "https://i.pravatar.cc/500?u=c" },
  { name: "Sarah Lauer", role: "Operations", img: "https://i.pravatar.cc/500?u=d" },
  { name: "Julian Stark", role: "Design Lead", img: "https://i.pravatar.cc/500?u=e" },
];
  ...
  return (
    <section id="team" className="relative py-20 lg:py-40 border-t border-text-secondary/20">
      <div className="px-6 lg:px-20 mb-12 lg:mb-20">
        <h2 className="text-4xl sm:text-5xl lg:text-7xl font-satoshi font-bold uppercase tracking-tighter">Command Center</h2>
      </div>
