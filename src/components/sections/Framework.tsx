...
const Framework: React.FC = () => {
  ...
  return (
    <section id="framework" className="relative py-20 lg:py-40 bg-surface/20 border-t border-b border-text-secondary/20 overflow-hidden">
      ...
      <div id="framework-container" className="relative w-full max-w-6xl mx-auto px-4 lg:px-6 py-10 lg:py-20 h-[700px] sm:h-[900px] lg:h-[1100px]">
            ...
            return (
              ...
              >
                ...
                <div className="flex relative items-center justify-center w-12 h-12 sm:w-16 sm:h-16 lg:w-24 lg:h-24 shrink-0">
                  ...
                  <div className={`flex absolute -top-2 lg:-top-3 ${isTextOnRight ? '-left-2 lg:-left-3' : '-right-2 lg:-right-3'} node-num text-accent font-mono text-[10px] lg:text-sm font-bold border-2 border-accent rounded-full min-w-[24px] h-[24px] lg:min-w-[36px] lg:h-[36px] items-center justify-center bg-background z-30 transition-colors duration-500`}>
                    {i+1}
                  </div>
                </div>
