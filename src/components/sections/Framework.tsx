...
const Framework: React.FC = () => {
  ...
  // Staggered Y offsets for a smooth curve effect
  const yOffsets = [0, 40, 100, 180, 280];
  ...
  return (
    <section id="framework" className="relative py-20 lg:py-40 bg-surface/20 border-t border-b border-text-secondary/20 overflow-hidden">
      ...
      <div className="relative w-full px-6 lg:px-20 overflow-x-auto pb-20 lg:pb-40 no-scrollbar">
        <div className="flex items-start min-w-[1200px] lg:min-w-[1400px] relative py-16 lg:py-24 h-[500px]">
          ...
          <div className="absolute top-[50px] sm:top-[70px] left-[10%] w-[80%] h-full z-0 pointer-events-none">
             <svg width="100%" height="100%" viewBox="0 0 1000 300" preserveAspectRatio="none" className="overflow-visible">
                ...
                <path d="M 0,0 C 250,40 500,100 750,180 C 850,220 950,260 1000,280" fill="none" stroke="rgba(168,168,168,0.3)" strokeWidth="2" strokeDasharray="10 10" />
                {/* Foreground animated path */}
                <path ref={progressRef} d="M 0,0 C 250,40 500,100 750,180 C 850,220 950,260 1000,280" fill="none" stroke="#D4A017" strokeWidth="4" />
             </svg>
          </div>
